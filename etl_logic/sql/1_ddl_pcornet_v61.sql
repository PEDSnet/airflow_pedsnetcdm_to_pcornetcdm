create schema if not exists {{ dag_run.conf['site'] }}_pcornet_airflow;

set search_path to {{ dag_run.conf['site'] }}_pcornet_airflow;
...
INSERT INTO version_history (operation, model, model_version, dms_version, dmsa_version) VALUES ('create tables', 'pcornet', '6.1.0', '1.0.4-beta', '0.7.1');
...
CREATE TABLE IF NOT EXISTS hash_token (
	patid VARCHAR(256) NOT NULL, 
	...
	token_06 VARCHAR(256), 
	token_07 VARCHAR(256), 
	token_08 VARCHAR(256), 
	token_09 VARCHAR(256), 
	token_101 VARCHAR(256), 
	token_102 VARCHAR(256), 
	token_103 VARCHAR(256), 
	token_104 VARCHAR(256), 
	token_105 VARCHAR(256), 
	token_106 VARCHAR(256), 
	token_107 VARCHAR(256), 
	token_108 VARCHAR(256), 
	token_109 VARCHAR(256), 
	token_110 VARCHAR(256), 
	token_111 VARCHAR(256), 
	token_12 VARCHAR(256), 
	token_14 VARCHAR(256), 
	token_15 VARCHAR(256), 
	token_16 VARCHAR(256), 
	token_17 VARCHAR(256), 
	token_18 VARCHAR(256), 
	token_23 VARCHAR(256), 
	token_24 VARCHAR(256), 
	token_25 VARCHAR(256), 
	token_26 VARCHAR(256), 
	token_29 VARCHAR(256), 
	token_30 VARCHAR(256), 
	token_encryption_key VARCHAR(256) NOT NULL, 
	CONSTRAINT xpk_hashtoken PRIMARY KEY (patid, token_encryption_key)
);
...
CREATE TABLE IF NOT EXISTS lab_result_cm (
	abn_ind VARCHAR(2), 
	encounterid VARCHAR(256), 
...
CREATE TABLE IF NOT EXISTS lds_address_history (
...
CREATE TABLE IF NOT EXISTS obs_clin (
	encounterid VARCHAR(256), 
	obsclin_abn_ind VARCHAR(2), 
	obsclin_code VARCHAR(18), 
...
CREATE TABLE IF NOT EXISTS obs_gen (
	encounterid VARCHAR(256), 
...
CREATE TABLE IF NOT EXISTS pcornet_trial (
...
CREATE TABLE IF NOT EXISTS private_address_geocode (
	addressid VARCHAR(256) NOT NULL, 
...
CREATE TABLE IF NOT EXISTS private_address_history (
	address_city VARCHAR(256), 
	address_county VARCHAR(256), 
...
CREATE TABLE IF NOT EXISTS private_demographic (
	biobank_flag VARCHAR(1), 
	birth_date DATE, 
	birth_time VARCHAR(5), 
	gender_identity VARCHAR(2), 
...
CREATE TABLE IF NOT EXISTS pro_cm (
	encounterid VARCHAR(256), 
	patid VARCHAR(256) NOT NULL, 
	pro_cat VARCHAR(2), 
...
CREATE TABLE IF NOT EXISTS vital (
	...
	wt NUMERIC(15, 8), 
	CONSTRAINT xpk_vitalid PRIMARY KEY (vitalid)
);
