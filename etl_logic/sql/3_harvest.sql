Begin;
UPDATE {{ dag_run.conf['site'] }}_pcornet_airflow.harvest
SET 
...
from 
    pcornet_maps.pedsnet_pcornet_valueset_map v1, 
    pcornet_maps.pedsnet_pcornet_valueset_map v2
WHERE 
    v1.source_concept_id = '{{ dag_run.conf['site'] }}' 
    and v1.source_concept_class = 'datamart_name' 
    and v2.source_concept_id = '{{ dag_run.conf['site'] }}' 
    and v2.source_concept_class = 'datamart_id';
commit;
