begin;
create table {{ dag_run.conf['site'] }}_pcornet_airflow.observation_extract as
select 
    obs.*
from
...
-- PHQ2 / PHQ9
begin;
insert into {{ dag_run.conf['site'] }}_pcornet_airflow.pro_cm (
    pro_cm_id,
    encounterid,
    patid,
    pro_date,
...
from 
    {{ dag_run.conf['site'] }}_pcornet_airflow.observation_extract obs
left join 
