...
from {{ dag_run.conf['site'] }}_pcornet.lab_result_cm l
...
and {{ dag_run.conf['site'] }}_pcornet.lab_result_cm.result_unit in ('','OT','NI') 
and l.lab_result_cm_id = {{ dag_run.conf['site'] }}_pcornet.lab_result_cm.lab_result_cm_id;
commit;
...
and {{ dag_run.conf['site'] }}_pcornet.lab_result_cm.lab_result_cm_id = l.lab_result_cm_id;
commit;
