begin;
create table {{ dag_run.conf['site'] }}_pcornet.observation_extract as
select 
    obs.*
from
...
-- PHQ2 / PHQ9
begin;
insert into {{ dag_run.conf['site'] }}_pcornet.pro_cm (
    pro_cm_id,
    encounterid,
    patid,
    pro_date,
...
from 
    {{ dag_run.conf['site'] }}_pcornet.observation_extract obs
left join 
