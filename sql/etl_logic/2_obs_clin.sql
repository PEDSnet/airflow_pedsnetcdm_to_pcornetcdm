begin;
INSERT INTO {{ dag_run.conf['site'] }}_pcornet.obs_clin(encounterid, obsclin_code, obsclin_start_date, obsclin_providerid, obsclin_result_modifier, obsclin_result_snomed, obsclin_result_qual, obsclin_result_text, 
...
select distinct on (obsclinid) encounterid, obsclin_code, obsclin_start_date, obsclin_providerid::text, obsclin_result_modifier, obsclin_result_snomed, obsclin_result_qual, obsclin_result_text::text, 
	...
	raw_obsclin_unit,obsclin_stop_date, obsclin_stop_time, site 
from {{ dag_run.conf['site'] }}_pcornet.meas_obsclin
union
select distinct on (obsclinid) encounterid, obsclin_code, obsclin_start_date, obsclin_providerid::text,obsclin_result_modifier, obsclin_result_snomed, obsclin_result_qual, obsclin_result_text::text, 
	obsclin_result_unit, obsclin_source, obsclin_start_time, obsclin_type, obsclin_abn_ind, obsclinid, patid, raw_obsclin_code, raw_obsclin_modifier, raw_obsclin_name, raw_obsclin_result::text, raw_obsclin_type, 
	raw_obsclin_unit,obsclin_stop_date, obsclin_stop_time, site 
from {{ dag_run.conf['site'] }}_pcornet.obs_vaping;

commit;

/* vital data - ht, wt, systolic, diastolic, bmi, bp*/
-- begin;
-- INSERT INTO {{ dag_run.conf['site'] }}_pcornet.obs_clin(encounterid, obsclin_code, obsclin_abn_ind, obsclin_start_date, obsclin_providerid, obsclin_result_modifier, obsclin_result_snomed, obsclin_result_qual, obsclin_result_text, 
...
/* vital data - tobacco*/
begin;
create table {{ dag_run.conf['site'] }}_pcornet.tobacco_obclin as
...
null as obsclin_stop_time,
tobac.site as site
from {{ dag_run.conf['site'] }}_pcornet.ob_tobacco_data tobac
...
begin;
INSERT INTO {{ dag_run.conf['site'] }}_pcornet.obs_clin( obsclinid,encounterid, obsclin_code, obsclin_abn_ind,obsclin_start_date, obsclin_providerid, obsclin_result_modifier, obsclin_result_snomed, obsclin_result_qual, obsclin_result_text, 
...
select distinct on (obsclinid) obsclinid, encounterid, obsclin_code, obsclin_abn_ind,obsclin_start_date, obsclin_providerid, obsclin_result_modifier, obsclin_result_snomed, obsclin_result_qual, obsclin_result_text, 
	obsclin_result_unit, obsclin_source, obsclin_start_time, obsclin_type, patid, raw_obsclin_code, raw_obsclin_modifier, raw_obsclin_name, raw_obsclin_result, raw_obsclin_type, 
	raw_obsclin_unit, obsclin_stop_date, obsclin_stop_time,site
from {{ dag_run.conf['site'] }}_pcornet.tobacco_obclin;

commit;

begin;

create table {{ dag_run.conf['site'] }}_pcornet.gestational_age as
...
null as obsclin_stop_time,
site as site
from {{ dag_run.conf['site'] }}_pedsnet.person p
...
select distinct on (obsclinid) obsclinid, encounterid, obsclin_code, obsclin_abn_ind,obsclin_start_date, obsclin_providerid, obsclin_result_modifier, obsclin_result_snomed, obsclin_result_qual, obsclin_result_text, 
	obsclin_result_unit, obsclin_source, obsclin_start_time, obsclin_type, patid, raw_obsclin_code, raw_obsclin_modifier, raw_obsclin_name, raw_obsclin_result, raw_obsclin_type, 
	raw_obsclin_unit, obsclin_stop_date, obsclin_stop_time,site
from {{ dag_run.conf['site'] }}_pcornet.gestational_age;

commit;

begin;
delete from {{ dag_run.conf['site'] }}_pcornet.obs_clin
...
drop table if exists {{ dag_run.conf['site'] }}_pcornet.tobacco_obclin;
drop table if exists {{ dag_run.conf['site'] }}_pcornet.gestational_age;
commit;
