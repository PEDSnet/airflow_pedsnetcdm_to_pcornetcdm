...
ALTER TABLE {{ dag_run.conf['site'] }}_pcornet.provider ALTER provider_npi SET DATA TYPE NUMERIC(20,0);

Insert into {{ dag_run.conf['site'] }}_pcornet.provider(providerid, provider_sex, 
